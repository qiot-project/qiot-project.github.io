...
image::/assets/images/posts/usecase-retail/retail_pos_high_level.png[image,width=2048,height=1152]

image::/assets/images/posts/usecase-retail/retail_pos_why.png[image,width=2048,height=1152]

image::/assets/images/posts/usecase-retail/retail_cloud_native_dev.png[image,width=2048,height=1152]

image::/assets/images/posts/usecase-retail/retail_cloud_native_dev_why.png[image,width=2048,height=1152]
...
image::/assets/images/posts/usecase-retail/architecture.png[image,width=2048,height=1162]
...
image::/assets/images/posts/usecase-manufacturing/fitlet2.jpg[image,width=1928,height=1509]
...
image::/assets/images/posts/usecase-retail/10000000000007D20000058987BF5C3A3F2FBEC8.png[image,width=2002,height=1416]
...
### Option 2) Virtual Alternative; RHEL Hypervisor running
in Azure
...
image::/assets/images/logo/logo-quarkus.png[image,width=859,height=900]
...
image::/assets/images/posts/usecase-retail/100000000000063500000208E7E31742DF3F4C9B.png[image,width=1588,height=519] +
The UI is a simple React application,
https://github.com/qiot-project/qiot-retail-edgepos-ui[_qiot-project/qiot-retail-edgepos-ui_].
...
platform designed to control the facility and the machineries.

image::/assets/images/posts/usecase-manufacturing/NUC.jpg[image,width=2118,height=1632]
...
image::/assets/images/posts/usecase-retail/backoffice.png[image,width=1071,height=811]

### OpenShift Container Platform

image::/assets/images/posts/usecase-retail/1000020100000599000001E7E5745675784A1B1F.png[image,width=1433,height=486]
...
image::/assets/images/posts/usecase-retail/10000000000002270000010F4A6E3D16AFD35DEB.png[image,width=364,height=179]
...
image::/assets/images/posts/usecase-retail/100002010000057800000547D36D42C9067C9414.png[image,width=1400,height=1350]
...
image::/assets/images/posts/usecase-retail/10000201000000DC000000E352E1150BC8AE0251.png[image,width=220,height=227]
...
image::/assets/images/posts/usecase-retail/strimzi.png[image,width=600,height=156]

image::/assets/images/posts/usecase-retail/100002010000045200000210CEAD1F33222F1DE6.png[image,width=1106,height=528]
...
The Stream service topics serve a variety of functionalities and
processes impacting the following workflows:

* *Product-line*: New Global product-line are delivered to the streaming
service for asyncronous consumption by the factories. This workflow
requires persistence and off-set management, both provided by the A-MQ
Streams product; +
* *Telemetry*: A-MQ perfectly fits into the canonical usecase of
telemetry stream and management. Compared to the previous use-case
implemented by the community, the team decided to go for a more
structured and scalable approach based on a could-native product, rather
that just relying on a communication protocol likehttps://mqtt.org/[
]https://mqtt.org/[_MQTT protocol_]. +

The implementation choices above make it easy to fine tune the
connections, the scalability, the message flow, and retention
separately.
...
image::/assets/images/posts/usecase-retail/grafana.png[image,width=2048,height=497]
...
image::/assets/images/posts/usecase-retail/devspaces.png[image,width=480,height=192]
